...
class CsvRestaurantLoaderTest {
    ...
    void loadAll_resolvesCuisineNames() {
        ...
        long withUnknown = restaurants.stream().filter(restaurant -> "Unknown".equals(restaurant.getCuisine())).count();
        ...
        boolean hasKnownCuisine = restaurants.stream()
                .anyMatch(restaurant -> "American".equals(restaurant.getCuisine()) || "Chinese".equals(restaurant.getCuisine()) || "Spanish".equals(restaurant.getCuisine()));
    ...
    void loadAll_everyRestaurantHasRequiredFields() {
        ...
        for (Restaurant restaurant : restaurants) {
            assertNotNull(restaurant.getName(), "name should not be null");
            assertFalse(restaurant.getName().isBlank(), "name should not be blank");
            assertNotNull(restaurant.getCuisine(), "cuisine should not be null");
            assertFalse(restaurant.getCuisine().isBlank(), "cuisine should not be blank");
        }
